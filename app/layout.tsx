...
import Phone from '@/public/call_24dp_FILL0_wght400_GRAD0_opsz24.svg';
  ...
  return (
    <html lang="en">
      <body className={poppins.className}>
        <nav className="bg-black/40 inset-x-1 top-0 left-0 w-full absolute z-50 py-4">
              ...
              <button>
                <Link href="http://instagram.com/">
                  <svg
                    ...
                    className="hover:brightness-125 fill-current"
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
